return {
	...
	keys = {
		...
		},
		{
			...
			desc = "Cerrar todas las notificaciones",
		},
		...
		},
		{
			...
			desc = "Seleccionar buffer Scratch",
		},
		{
			"<leader>dps",
			function()
		...
		},
		{
			...
			desc = "Buscar texto (directorio raíz)",
		},
		{
			"<leader>:",
			function()
		...
		},
		{
			...
			desc = "Buscar archivos (directorio raíz)",
		},
		...
		},
		{
			"<leader>fF",
			function()
				Snacks.picker.files({ cwd = (vim.uv or vim.loop).cwd() })
			end,
		...
		},
		{
			...
			desc = "Issues de GitHub (abiertas)",
		},
		{
			"<leader>gI",
			function()
		...
		},
		{
			...
			desc = "Buscar en buffers abiertos",
		},
		{
			"<leader>sg",
			function()
			...
			desc = "Grep (directorio raíz)",
		},
		{
			"<leader>sG",
			function()
				Snacks.picker.grep({ cwd = (vim.uv or vim.loop).cwd() })
			end,
			desc = "Grep (cwd)",
		},
		{
			...
			desc = "Buscar especificación de plugin",
		},
		{
			"<leader>sw",
			function()
			...
			desc = "Selección/palabra (raíz)",
			mode = { "n", "x" },
		},
		{
			"<leader>sW",
			function()
				Snacks.picker.grep({ search = vim.fn.expand("<cword>"), cwd = (vim.uv or vim.loop).cwd() })
			end,
			desc = "Selección/palabra (cwd)",
			mode = { "n", "x" },
		},
		...
		},
		{
			...
			desc = "Lista de ubicación (loclist)",
		},
		{
			"<leader>sM",
			function()
